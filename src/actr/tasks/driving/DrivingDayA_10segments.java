...
public class DrivingDayA_10segments extends Task {
	...
	private final double accelFactor_thw = (1 * .40); // 1 orig, 3?
	private final double accelFactor_dthw = (3 * .40); // 3 orig, 5?
	private final double steerNaMax = .07; // orig 0.7
	...
	@Override
	public void start() {
		outPara = new File("./resultDriving/Results_Fatigue_Parameters(Day).csv");
		out = new File("./resultDriving/Results_Model_driving(Day).csv");
