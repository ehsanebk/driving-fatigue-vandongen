...
public class DrivingPVTDayPOST extends Task {
	...
	public void start() {
		...
		getModel().getFatigue().setCumulativeParameter(30);
...
//	}
	...
	public Result analyze(Task[] tasks, boolean output) {
		...
		try {
			...
			File dataFile = new File("/Users/Ehsan/OneDrive - Drexel University/Driving Data(Van Dongen)/Result_PVT/Model_PVT_DayPOST.csv");
			if (!dataFile.exists())
